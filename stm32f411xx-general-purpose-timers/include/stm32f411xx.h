...
/* CORE PERIPHERALS */
#define STK_ADDR   0xe000e010    /* SysTick address */
typedef struct {
...
#define RCC_ADDR       0x40023800    /* RCC address boundary (0x4002 3800 - 0x4002 3BFF) : AHB1 */
typedef struct {
...
#define TIM4_ADDR         0x40000800  /* TIM4 address boundary (0x4000 0800 - 0x4000 0BFF) : APB1 */
#define TIM5_ADDR         0x40000c00  /* TIM5 boundary address (0x4000 0C00 - 0x4000 0FFF) : APB1 */
typedef struct {
