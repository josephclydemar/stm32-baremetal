...
#define PA2 (volatile gpio_pin_t){ .port = ((volatile gpio_t *)GPIOA_START), .pin = 2 }
#define PA3 (volatile gpio_pin_t){ .port = ((volatile gpio_t *)GPIOA_START), .pin = 3 }
#define PA4 (volatile gpio_pin_t){ .port = ((volatile gpio_t *)GPIOA_START), .pin = 4 }
